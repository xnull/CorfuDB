...
public class SequencerClient extends AbstractClient {
     ...
     * @param updateExistingSequencer True, if this is a delta message and just updates an existing
     *                                primary sequencer with the new epoch. False otherwise.
    ...
    public CompletableFuture<Boolean> bootstrap(Long initialToken, Map<UUID, Long> sequencerTails,
                                                ...
                                                boolean updateExistingSequencer) {
