...
public class SequencerTailsRecoveryMsg implements ICorfuPayload<SequencerTailsRecoveryMsg> {
    ...
    /**
     * Boolean flag to denote whether this bootstrap message is just updating and existing primary
     * sequencer with the new epoch (if set to true) or bootstrapping a currently NOT_READY
     * sequencer.
     */
    private Boolean updateExistingSequencer;
    ...
    public SequencerTailsRecoveryMsg(ByteBuf buf) {
        ...
        updateExistingSequencer = ICorfuPayload.fromBuffer(buf, Boolean.class);
    }
    ...
    public void doSerialize(ByteBuf buf) {
        ...
        ICorfuPayload.serialize(buf, updateExistingSequencer);
    }
}
