...
public class ManagementViewTest extends AbstractViewTest {
    ...
    public void regressTokenCountToValidDispatchedTokens() throws Exception {
        ...
        assertThat(server0.getReadyStateEpoch()).isEqualTo(layout_1.getEpoch());
        assertThat(server1.getReadyStateEpoch()).isEqualTo(layout_2.getEpoch());
        ...
        // client on PORT_0.
        assertThat(server0.getReadyStateEpoch()).isEqualTo(layout_3.getEpoch());
        assertThat(server1.getReadyStateEpoch()).isEqualTo(layout_2.getEpoch());
